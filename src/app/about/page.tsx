		...
		<div className='flex flex-col justify-center items-center mt-10 md:mt-40 md:flex-row md:pl-5 md:mr-5'>
			...
			<div className='flex flex-col items-center md:ml-5 md:items-start'>
				...
				<p className='text-stone-600 mt-5 text-center tracking-wider px-20 md:text-left md:px-0 md:w-full'>
					...
					in technical and executive roles in scientific research and computing,
					enterprise software, and, most recently, municipal government and
					community organizing. The constant through all these endeavors has
					been the use of data to develop insights, make decisions, and support
					accountability.
				</p>
				<LinkedLogo_hover />
			</div>
