...
export default function Home() {
	return (
		<>
			...
			<div className='flex bg-white-opacity-50 w-full mt-40'>
				<div className='flex flex-col mt-10'>
					<div
						className={
							"text-stone-600 text-4xl font-bold text-opacity-100 opacity-100 pb-8 ml-5 sm:ml-20 sm:text-5xl md:text-6xl lg:ml-40"
						}
					>
