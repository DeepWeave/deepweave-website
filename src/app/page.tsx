			...
			<div className='flex bg-white-opacity-50 w-full justify-center mt-40 sm:justify-start md:justify-start'>
				<div className='flex flex-col mt-10'>
					...
					<div className='flex pt-9 pb-5 justify-end sm:pr-3'>
						<Link href='/contact'>
							<button className='bg-yellow-400 text-sky-700 font-semibold text-sm py-1 px-4 rounded-full tracking-wider transition ease-out duration-500 hover:bg-yellow-500 md:py-2 md:px-8 md:text-base'>
								CONTACT
							</button>
						</Link>
					</div>
